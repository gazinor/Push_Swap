...
void		exec_n_instructions(t_int_list *a, t_int_list *b,
				int n, char *inst);

void		make_moves_from_rots(t_int_list *a, t_int_list *b,
				int rotA, int rotB);

void		make_moves_from_rots2(t_int_list *a, t_int_list *b,
				int rotA, int rotB);
